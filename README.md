...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.55-blue" alt="version">
...
## 近期更新
- **v3.55** — 強化匯率查詢路線，增加 TWDUSD 後備，實現 TWD → USD → 目標貨幣的完整轉換
- **v3.54** — 修正 USD 中介轉換計算邏輯，JPY、CNY、HKD 等貨幣匯率恢復正常
