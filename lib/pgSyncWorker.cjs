...
const configuredConnectionTimeout = Number.parseInt(
...
const connectionTimeoutMillis =
  Number.isFinite(configuredConnectionTimeout) && configuredConnectionTimeout > 0
    ...
    : 5000;
// Release idle PostgreSQL sockets promptly so an otherwise idle Railway
// service can become eligible for Serverless sleeping.
const pool = new Pool({
  connectionString,
