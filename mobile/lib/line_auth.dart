...
class LineAuth {
  ...
  static Future<void> signIn({
    ...
    try {
      ...
      if (!launched) throw ApiException(0, trKey('mobileLegacyUnableToOpenTheBrowserForLineSign'));
      ...
      try {
        ...
        throw ApiException(0, trKey('mobileLegacyLineSignInTimedOutOrWasCancelled'));
      }

      final returnedState = cb.queryParameters['state'] ?? '';
      if (returnedState != state) throw ApiException(0, trKey('mobileLegacyLineSignInStateMismatchTryAgain'));
