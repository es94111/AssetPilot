(()=>{var a={};a.id=7688,a.ids=[7688],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},8086:a=>{"use strict";a.exports=require("module")},9256:(a,b,c)=>{"use strict";c.d(b,{OB:()=>i,VX:()=>h,ZT:()=>j,oC:()=>f,si:()=>k,ts:()=>g});var d=c(86802),e=c(66147);async function f(a){return await (0,e.requireAuth)()}function g(a){return{id:a.id,email:a.email,displayName:a.display_name,isAdmin:!!a.is_admin,themeMode:a.theme_mode}}async function h(a,b){return(await (0,d.cookies)()).set("authToken",b,{httpOnly:!0,secure:!0,sameSite:"strict",path:"/",maxAge:604800}),a}async function i(){(await (0,d.cookies)()).delete("authToken")}async function j(){return await f()}function k(a){let b=String(a||"").trim().toLowerCase();return"light"===b||"dark"===b||"system"===b?b:"system"}c(30477)},10052:(a,b,c)=>{"use strict";!function(){let b=a.exports?c(17628):null,d={TWD:1,USD:100,EUR:100,GBP:100,CNY:100,SGD:100,HKD:100,AUD:100,CAD:100,NZD:100,CHF:100,MYR:100,THB:100,PHP:100,JPY:1,KRW:1,VND:1,IDR:1,BHD:1e3,KWD:1e3,OMR:1e3,JOD:1e3,TND:1e3};function e(a){if("string"!=typeof a)return 1;let b=a.toUpperCase();if(Object.prototype.hasOwnProperty.call(d,b))return d[b];try{let a=new Intl.NumberFormat("en",{style:"currency",currency:b}),c=a.resolvedOptions?a.resolvedOptions():{},d="number"==typeof c.maximumFractionDigits?c.maximumFractionDigits:2;return Math.pow(10,d)}catch(a){return 100}}a.exports&&(a.exports={SMALLEST_UNIT_BY_CURRENCY:d,getSmallestUnit:e,computeTwdAmount:function(a,c,d){if(!b)throw Error("decimal.js not loaded; ensure CDN script loaded before lib/moneyDecimal.js");let e=new b(a||0),f=new b(null!=c?String(c):"1"),g=new b(d||0);return e.times(f).plus(g).toDecimalPlaces(0,b.ROUND_HALF_UP).toNumber()},formatForDisplay:function(a,b){"number"==typeof a&&isFinite(a)||(a=0);let c=e(b),d=1===c?0:1e3===c?3:2,f=a/c;try{return new Intl.NumberFormat("zh-TW",{style:"currency",currency:(b||"TWD").toUpperCase(),minimumFractionDigits:d,maximumFractionDigits:d}).format(f)}catch(a){return`${(b||"TWD").toUpperCase()} ${f.toLocaleString("en-US",{minimumFractionDigits:d,maximumFractionDigits:d})}`}},calcFifoLots:function(a){if(!b)throw Error("decimal.js not loaded");let c=[],d=new b(0),e=new b(0),f=[];for(let g of Array.isArray(a)?a:[]){let a=new b(g.shares||0),h=new b(g.price||0),i=new b(g.fee||0),j=new b(g.tax||0);if("buy"===g.type)c.push({shares:a,price:h,fee:i}),d=d.plus(a);else if("sell"===g.type){let k=a,l=a.times(h).minus(i).minus(j),m=new b(0);for(;k.gt(0)&&c.length>0;){let a=c[0],d=b.min(k,a.shares),e=a.shares.gt(0)?a.fee.times(d).div(a.shares):new b(0);m=m.plus(d.times(a.price)).plus(e),a.fee=a.fee.minus(e),a.shares=a.shares.minus(d),k=k.minus(d),a.shares.lte(0)&&c.shift()}let n=l.minus(m);e=e.plus(n),d=d.minus(a);let o=a.gt(0)?m.div(a):new b(0),p=m.gt(0)?n.div(m).times(100):new b(0);f.push({tx:g,sellRevenue:l,totalCost:m,realizedPL:n,costPerShare:o,returnRate:p})}}let g=c.reduce((a,b)=>a.plus(b.shares.times(b.price)).plus(b.fee),new b(0));return{lots:c,totalShares:d,totalCost:g,realizedPL:e,sellEntries:f}}})}()},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},12412:a=>{"use strict";a.exports=require("assert")},16825:(a,b,c)=>{"use strict";let d=c(33873),e=c(29021),f=c(55511),g=process.env.DB_PATH||d.join(process.cwd(),"database.db"),h=process.env.DB_ENCRYPTION_KEY||"",i=Buffer.from("EADB");function j(a,b){return f.pbkdf2Sync(a,b,1e5,32,"sha256")}function k(a,b){let c=f.randomBytes(16),d=j(b,c),e=f.randomBytes(12),g=f.createCipheriv("chacha20-poly1305",d,e,{authTagLength:16}),h=Buffer.concat([g.update(a),g.final()]),k=g.getAuthTag();return Buffer.concat([i,c,e,k,h])}function l(a,b){if(a.length<48)throw Error("加密檔案格式錯誤：檔案太小");if(!a.subarray(0,4).equals(i))throw Error("非加密資料庫檔案");let c=a.subarray(4,20),d=a.subarray(20,32),e=a.subarray(32,48),g=a.subarray(48),h=j(b,c),k=f.createDecipheriv("chacha20-poly1305",h,d,{authTagLength:16});return k.setAuthTag(e),Buffer.concat([k.update(g),k.final()])}function m(a){return!!Buffer.isBuffer(a)&&a.length>=4&&a.subarray(0,4).equals(i)}let n=globalThis.__sqlDb||null,o=!1,p=!1;function q(){if(o){p=!0;return}o=!0,(async()=>{try{for(;;){p=!1;let a=n.export(),b=Buffer.from(a),c=h?k(b,h):b,d=g+".tmp";if(await e.promises.writeFile(d,c),await e.promises.rename(d,g),!p)break}}catch(a){console.error("saveDB failed:",a?.message??a)}finally{o=!1}})()}function r(){let a=n.export(),b=Buffer.from(a),c=h?k(b,h):b;e.writeFileSync(g,c)}function s(){if(n||(n=globalThis.__sqlDb??null),!n)throw Error("DB 尚未初始化，請確認 instrumentation.js 已執行");return n}async function t(){let a=n;a.run(`CREATE TABLE IF NOT EXISTS users (
    id TEXT PRIMARY KEY,
